...
public class Object3DBuilder {
    ...
    public static Object3DData loadV5(Activity activity, InputStream modelUri) {
        try {
            //final String modelId = assetDir + "/" + assetFilename;

            InputStream is = modelUri;
    ...
    public static Object3DData generateArrays(Object3DData obj) throws IOException {
        ...
        if (materials != null) {
            ...
            try(String inputStream = ContentsUtils.getInputStream(materials.mfnm)) {
...
*/
        ...
        if (materials != null && !materials.materials.isEmpty()) {
            ...
            if (texture != null) {
                ...
                InputStream is = ContentsUtils.getInputStream(texture);
                if (is != null) {
                    textureData = ContentsUtils.read(is);
                    is.close();
                } else {
