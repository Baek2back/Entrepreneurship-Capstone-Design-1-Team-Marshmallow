...
import com.capstone.seoae.SeoaeNaviApplication;
...
public final class Util {
    ...
    private static float getDensityScalar() {
        return SeoaeNaviApplication.getInstance().getResources().getDisplayMetrics().density;
    }
    ...
    private static String readTextFileFromRawRes(@RawRes int resourceId) {
        InputStream inputStream = SeoaeNaviApplication.getInstance().getResources()
