...
import com.marshmallow.project.animation.Animator;
import com.marshmallow.project.drawer.DrawerFactory;
import com.marshmallow.project.drawer.Object3DImpl;
import com.marshmallow.project.model.AnimatedModel;
import com.marshmallow.project.model.Object3D;
import com.marshmallow.project.model.Object3DData;
import com.marshmallow.project.model.SceneCamera;
import com.marshmallow.project.service.Object3DBuilder;
import com.marshmallow.project.util.GLUtil;
...
public class ModelRenderer implements GLSurfaceView.Renderer {
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        // INFO: Set the SceneCamera position (View matrix)
        // The camera2 has 3 vectors (the position, the vector where we are looking at, and the up position (sky)
        SceneLoader scene = main.getNavigationActivity().getScene();
        SceneCamera sceneCamera = scene.getSceneCamera();
        Matrix.setLookAtM(modelViewMatrix, 0, sceneCamera.xPos, sceneCamera.yPos, sceneCamera.zPos, sceneCamera.xView, sceneCamera.yView,
                sceneCamera.zView, sceneCamera.xUp, sceneCamera.yUp, sceneCamera.zUp);
    ...
    public void onDrawFrame(GL10 unused) {
        ...
        scene = main.getNavigationActivity().getScene();
        if (scene == null) {
            // scene not ready
            return;
        }
        ...
        if (sceneCamera.hasChanged()) {
            Matrix.setLookAtM(modelViewMatrix, 0, sceneCamera.xPos, sceneCamera.yPos, sceneCamera.zPos, sceneCamera.xView, sceneCamera.yView,
                    sceneCamera.zView, sceneCamera.xUp, sceneCamera.yUp, sceneCamera.zUp);
            Matrix.multiplyMM(mvpMatrix, 0, modelProjectionMatrix, 0, modelViewMatrix, 0);
            sceneCamera.setChanged(false);
        }
    ...
    public SceneLoader getSceneLoader() { return scene; }
}