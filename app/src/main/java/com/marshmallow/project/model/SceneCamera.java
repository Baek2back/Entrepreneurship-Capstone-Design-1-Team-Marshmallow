package com.marshmallow.project.model;
...
public class SceneCamera {
    ...
    public float xPos, yPos; // Camera2 position.
    public float zPos;
    ...
    public SceneCamera(float xPos, float yPos, float zPos, float xView, float yView, float zView, float xUp, float yUp,
                   float zUp) {
    ...
    public String toString() {
        return "Camera2 [xPos=" + xPos + ", yPos=" + yPos + ", zPos=" + zPos + ", xView=" + xView + ", yView=" + yView
