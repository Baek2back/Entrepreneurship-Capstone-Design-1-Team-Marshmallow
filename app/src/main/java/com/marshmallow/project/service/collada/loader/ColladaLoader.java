package com.marshmallow.project.service.collada.loader;

import android.opengl.GLES20;
import android.util.Log;

import com.marshmallow.project.animation.Animation;
import com.marshmallow.project.animation.JointTransform;
import com.marshmallow.project.animation.KeyFrame;
...
import com.marshmallow.project.service.collada.entities.AnimationData;
import com.marshmallow.project.service.collada.entities.Joint;
import com.marshmallow.project.service.collada.entities.JointData;
import com.marshmallow.project.service.collada.entities.JointTransformData;
import com.marshmallow.project.service.collada.entities.KeyFrameData;
import com.marshmallow.project.service.collada.entities.MeshData;
import com.marshmallow.project.service.collada.entities.SkeletonData;
import com.marshmallow.project.service.collada.entities.SkinningData;
import com.marshmallow.project.service.wavefront.WavefrontLoader;
import com.marshmallow.project.xml.XmlNode;
import com.marshmallow.project.xml.XmlParser;
...
public class ColladaLoader {
    ...
    public static void populateAnimatedModel(InputStream inputStream, List<Object3DData> datas, AnimatedModelData modelData){
        ...
        for (int i=0; i<datas.size(); i++) {
            ...
            try {
                ...
                // load animation
                Animation animation = loadAnimation(inputStream);
