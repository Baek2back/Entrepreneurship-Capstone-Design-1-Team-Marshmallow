...
import com.marshmallow.project.service.collada.ColladaLoaderTask;
import com.marshmallow.project.util.ContentsUtils;
...
public class SceneLoader implements LoaderTask.Callback {
     ...
     * Parent component
     */
    protected final NavigationActivity parent;
    /**
    ...
    public SceneLoader(NavigationActivity main) {
        this.parent = main;
    }
